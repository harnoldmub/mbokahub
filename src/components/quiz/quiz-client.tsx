...
const ALL_QUESTIONS = [
  ...
  {
    id: 52,
    question: "Quel artiste français a collaboré avec Fally sur le titre « Bad Boy » (2018) ?",
    options: ["Aya Nakamura", "Maître Gims", "Booba", "MHD"],
    correct: 0,
    anecdote: "« Bad Boy » avec Aya Nakamura est devenu un hymne afro-pop diaspora, certifié or en France.",
    category: "Carrière",
    album: ALBUMS.control,
    image: "/images/fally/fally-paris.jpg",
  },
  {
    ...
    correct: 1,
    anecdote: "Le 28 février 2020, Fally Ipupa remplit Bercy — premier artiste congolais à le faire seul.",
    category: "Concert",
    album: ALBUMS.tokooos,
    image: "/images/fally/fally-paris.jpg",
  },
  ...
  {
    id: 55,
    question: "Avec quel rappeur français Fally a-t-il fait le titre « Money Time » ?",
    options: ["Booba", "Niska", "Kaaris", "Naza"],
    correct: 0,
    anecdote: "Booba et Fally Ipupa : la rencontre du rap français et de la rumba moderne.",
    category: "Carrière",
    album: ALBUMS.control,
    image: "/images/fally/fally-global-citizen.jpg",
  },
  ...
  {
    id: 59,
    question: "Quel duo Fally a-t-il formé avec l'artiste américain R. Kelly ?",
    options: ["Original", "Bad Like Me", "Sweet Life", "Likolo"],
    correct: 2,
    anecdote: "« Sweet Life » avec R. Kelly était une collaboration historique entre rumba et R&B américain.",
    category: "Carrière",
    album: ALBUMS.power,
    image: "/images/fally/fally-global-citizen.jpg",
  },
  ...
  {
    id: 62,
    question: "Dans quel clip Fally apparaît-il avec l'icône M. Pokora ?",
    options: ["Juste une danse", "Si tu me vois", "Original", "Chaba"],
    correct: 0,
    anecdote: "« Juste une danse » (2018) est la collab afro-pop avec M. Pokora qui a cartonné en France.",
    category: "Carrière",
    album: ALBUMS.control,
    image: "/images/fally/fally-paris.jpg",
  },
  ...
  {
    id: 68,
    question: "Quel est le nom du tube collaboratif avec Dadju ?",
    options: ["Si tu me vois", "Bella", "Reine", "Comme dans un film"],
    correct: 2,
    anecdote: "« Reine » avec Dadju est une ballade afro-pop qui a fait l'unanimité chez les fans.",
    category: "Carrière",
    album: ALBUMS.formule,
    image: "/images/fally/fally-paris.jpg",
  },
  ...
  {
    id: 75,
    question: "Quel artiste belgo-congolais Fally a-t-il featurisé sur « Likolo » ?",
    options: ["Damso", "Krisy", "Ya Levis", "Aya Nakamura"],
    correct: 2,
    anecdote: "Ya Levis Dalwear est l'un des featurings remarqués de la nouvelle génération avec Fally.",
    category: "Carrière",
    album: ALBUMS.formule,
    image: "/images/fally/fally-paris.jpg",
  },
  ...
  {
    id: 79,
    question: "Quelle célèbre chanteuse ivoirienne Fally a-t-il invitée sur « Original » ?",
    options: ["Aya Nakamura", "Olivia Yacé", "Josey", "Roseline Layo"],
    correct: 0,
    anecdote: "« Original » avec Aya Nakamura mêle francophonie pop et rumba moderne.",
    category: "Carrière",
    album: ALBUMS.control,
    image: "/images/fally/fally-paris.jpg",
  },
  ...
  {
    id: 102,
    question: "Dans « Original », quel mot Fally crie en boucle au refrain ?",
    options: ["« Original »", "« Bébé »", "« Mama »", "« Yebisa »"],
    correct: 0,
    anecdote: "« Original » est lancé comme un mantra — gimmick instantanément reconnaissable.",
    category: "Paroles",
    album: ALBUMS.control,
    image: "/images/fally/fally-paris.jpg",
  },
  ...
  {
    id: 108,
    question: "Dans « Reine » (feat. Dadju), quel surnom Fally donne à sa femme ?",
    options: ["« Mon trésor »", "« Ma reine »", "« Ma déesse »", "« Mon ange »"],
    correct: 1,
    anecdote: "« Tu es ma reine » — Fally et Dadju en duo sur une ballade célébrant la femme aimée.",
    category: "Paroles",
    album: ALBUMS.formule,
    image: "/images/fally/fally-paris.jpg",
  },
