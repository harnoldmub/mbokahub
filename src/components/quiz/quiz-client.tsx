...
const QUESTIONS = [
  {
    ...
    album: ALBUMS.droit,
    anecdote:
      "Son nom complet est Fally Ipupa Diamond Gode — le surnom « Diamond » est devenu sa marque de fabrique.",
    category: "Identité",
  },
  {
    id: 2,
    ...
    anecdote:
      "Fally est né à Kinshasa, capitale de la RD Congo, le 14 décembre 1977.",
    category: "Biographie",
  },
  {
    id: 3,
    ...
    album: ALBUMS.power,
    anecdote:
      "Fally a brillé dans le Quartier Latin de Koffi Olomidé au début des années 2000 avant son envol solo en 2006.",
    category: "Carrière",
  },
  {
    id: 4,
    ...
    album: ALBUMS.droit,
    anecdote:
      "« Droit Chemin » sort en 2006 et pose la premiere pierre de sa carriere solo.",
    category: "Discographie",
  },
  {
    id: 5,
    question:
      "Pour quelle organisation internationale Fally est-il ambassadeur ?",
    options: ["UNESCO", "OMS", "UNICEF", "ONU Femmes"],
    correct: 2,
    image: "/images/fally/fally-cameroun-2021.jpg",
    album: ALBUMS.control,
    anecdote:
      "Fally est ambassadeur de l'UNICEF depuis 2012, s'engageant pour les droits des enfants dans le monde.",
    category: "Engagement",
  },
  {
    id: 6,
    ...
    album: ALBUMS.power,
    anecdote:
      "« Power Icarius » — une fusion de puissance et de mythologie qui résume l'aura scénique de Fally.",
    category: "Identité",
  },
  {
    id: 7,
    question:
      "Dans quelle salle parisienne Fally a-t-il performé avant le Stade de France ?",
    options: [
      "La Cigale",
      "Zénith de Paris",
      "Salle Pleyel",
    ...
    anecdote:
      "Fally a rempli l'Accor Arena plusieurs fois — avant de franchir l'ultime étape : le Stade de France.",
    category: "Concerts",
  },
  {
    id: 8,
    ...
    anecdote:
      "Le duo « Jaloux » avec Dadju a conquis la France entière et ouvert Fally à un public francophone encore plus large.",
  ...
  },
  {
    ...
    album: ALBUMS.arsenal,
    anecdote:
      "Fally est le maître du Ndombolo, dérivé énergique de la rumba congolaise — enrichi de sonorités modernes.",
    category: "Musique",
  },
  {
    id: 10,
    question:
      "Les 2 et 3 mai 2026, Fally entre dans l'histoire en faisant quoi ?",
    options: [
    ...
    album: ALBUMS.formule,
    anecdote:
      "Fally Ipupa devient le premier artiste congolais à se produire au Stade de France — deux nuits consécutives !",
    category: "Histoire",
  },
] as const;
