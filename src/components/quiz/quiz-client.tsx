...
const ALL_QUESTIONS = [
  ...
  {
    id: 52,
    question: "Sur quel album figure le titre « Bad Boy » de Fally Ipupa ?",
    options: ["Power Kosa Leka", "Tokooos", "Control", "Formule 7"],
    correct: 2,
    anecdote: "« Bad Boy » est extrait de l'album Control (2018), période où Fally enchaîne les hits.",
    category: "Discographie",
    album: ALBUMS.control,
    image: "/images/fally/fally-paris.jpg",
  },
  ...
  {
    id: 62,
    question: "Sur quel album figure le titre « Bloqué » ?",
    options: ["Tokooos", "Power Kosa Leka", "Control", "Formule 7"],
    correct: 2,
    anecdote: "« Bloqué » est extrait de l'album Control (2018), période phare de Fally en France.",
    category: "Discographie",
    album: ALBUMS.control,
    image: "/images/fally/fally-paris.jpg",
  },
  ...
  {
    id: 102,
    question: "Quel mot donne son titre à un single signature de Fally extrait de l'album Control ?",
    options: ["« Mannequin »", "« Original »", "« Bloqué »", "Tous ces titres figurent sur Control"],
    correct: 3,
    anecdote: "Mannequin, Original et Bloqué figurent tous sur Control (2018) — l'album du grand crossover.",
    category: "Paroles",
    album: ALBUMS.control,
    image: "/images/fally/fally-paris.jpg",
  },
