...
const stats = [
  ...
  { value: "Boost", label: "seule visibilité payante" },
];
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              },
              {
                ...
                text: "La plateforme reste gratuite, la visibilité devient le produit payant.",
              },
              {
                icon: BarChart3,
                title: "Stats à venir",
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
          <div className="flex flex-col justify-between gap-6 border-t border-[#d7dbe2] pt-10 sm:flex-row sm:items-center">
            <div>
              <p className="inline-flex items-center gap-2 text-sm text-paper-dim">
                <Star className="size-4 fill-blood text-blood" />
                Inspiré par les meilleurs standards de réservation beauté.
              </p>
              <h2 className="mt-3 text-3xl font-semibold text-paper">
                Gratuit pour tous. Payant seulement pour être mis en avant.
              </h2>
            </div>
